...
from src.scraper.Util import build_expedia_url

def parse(source,destination,date,secondDate):
    for i in range(5):
        # try:
        # url = build_expedia_url(source, destination)
...
if __name__=="__main__":
    ...
    argparser.add_argument('secondDate',help = 'MM/DD/YYYY')
    ...
    scraped_data = parse(source,destination,date,secondDate)
    print("Writing data to output file")
    with open('/home/squeaky/%s-%s-flight-results.json'%(source,destination),'w') as fp:
